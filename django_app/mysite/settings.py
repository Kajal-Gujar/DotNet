...
SECRET_KEY = 'django-insecure-q7j)mwgh%-cn4@3*ea1cdpcuac+x%-^m(f@pv2z%30g9fgb%3d'
...
INSTALLED_APPS = [
    ...
    'core',  # Our example app demonstrating MVT architecture
]
...
# IMPORTANT: Replace the placeholder values below with your actual PostgreSQL credentials
DATABASES = {
    'default': {
...
# Alternative: Use SQLite for quick testing (uncomment to use SQLite instead)
# DATABASES = {
#     'default': {
